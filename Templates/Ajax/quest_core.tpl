...
if (isset($qact)){
 switch($qact) {
	...
	$Subject= $lang['quest']['reward'][0]; //"Message From The Taskmaster"
	$Message= $lang['quest']['reward'][1]; //"You are to be informed that a nice reward is waiting for you at the taskmaster.<br /><br />Hint: The message has been generated automatically. An answer is not necessary."
...
define('IMG_WOOD','<img src=\"img\/x.gif\" class=\"r1\" alt=\"'.LUMBER.'\" title=\"'.LUMBER.'\" \/>');
define('IMG_CLAY','<img src=\"img\/x.gif\" class=\"r2\" alt=\"'.CLAY.'\" title=\"'.CLAY.'\" \/>');
define('IMG_IRON','<img src=\"img\/x.gif\" class=\"r3\" alt=\"'.IRON.'\" title=\"'.IRON.'\" \/>');
define('IMG_CROP','<img src=\"img\/x.gif\" class=\"r4\" alt=\"'.CROP.'\" title=\"'.CROP.'\" \/>');
function resReward($lumber,$clay,$iron,$crop)
{
	$text = IMG_WOOD.$lumber."&nbsp;&nbsp;".IMG_CLAY.$clay."&nbsp;&nbsp;".IMG_IRON.$iron."&nbsp;&nbsp;".IMG_CROP.$crop."&nbsp;&nbsp;";
	return $text;
}
...
if($session->access!=BANNED){
	  ...
	  /*
		0 => 'Welcome to ',
		1 => 'As I see you have been made chieftain of this little village. I will be your counselor for the first few days and never leave your (right hand) side.',
		2 => 'To the first task.',
...
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][0][0].SERVER_NAME; ?>!<\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][0][1]; ?>&rdquo;<\/i><br \/><br \/><span id=\"qst_accpt\"><a class=\"qle\" href=\"javascript: qst_next('','enter'); \"><?php echo $lang['quest'][0][2]; ?><\/a><a class=\"qri\" href=\"javascript: qst_fhandle();\"><?php echo $lang['quest'][0][3]; ?><\/a><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><br \/><br \/><br \/><a class=\"qri\" href=\"javascript: qst_next('','skip');\"><?php echo $lang['quest'][0][4]; ?><\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"intro\"><\/div>\n\t\t","number":null,"reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>g","msrc":"<?php echo $messagelol; ?>","altstep":1}
...
if ($woodL<1){
	  /*
		0 => 'Task 1: Woodcutter',
		1 => 'There are four green forests around your village. Construct a woodcutter on one of them. Lumber is an important resource for our new settlement.',
		2 => 'Order:<\/p>Construct a woodcutter.',
		3 => 'Yes, that way you gain more lumber.I helped a bit and completed the order instantly.',
		4 => 'Your reward:<\/p>Woodcutter instantly completed.'     
	  */
?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][1][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][1][1];?>&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><?php echo $lang['quest'][1][2];?><\/div><br \/><span id=\"qst_accpt\"><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"wood\"><\/div>\n\t\t","number":"-1","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }else{ ?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][1][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][1][3];?>&rdquo;<\/i><br \/><br \/><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><div class=\"rew\"><p class=\"ta_aw\"><?php echo $lang['quest'][1][4];?><br \/><\/div><br \/><span id=\"qst_accpt\"><a href=\"javascript: qst_next('','2');\"><?php echo $lang['quest'][0][5];?><\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"wood\"><\/div>\n\t\t","number":"-1","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }?>
...
if ($cropL<1){
	  /*
		0 => 'Task 2: Crop',
		1 => 'Now your subjects are hungry from working all day. Extend a cropland to improve your subjects supply. Come back here once the building is complete.',
		2 => 'Order:<\/p>Extend one cropland.',
		3 => 'Very good. Now your subjects have enough to eat again...'
	  */
?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][2][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][2][1];?>&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><?php echo $lang['quest'][2][2];?><\/div><br \/><span id=\"qst_accpt\"><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"farm\"><\/div>\n\t\t","number":"-2","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }else{ ?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][2][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][2][3];?>&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><?php echo $lang['quest'][0][6]."<\/p>".resReward(50,60,30,10);?><\/div><br \/><span id=\"qst_accpt\"><a href=\"javascript: qst_next('','3');\"><?php echo $lang['quest'][0][5];?><\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"farm\"><\/div>\n\t\t","number":2,"reward":{"plus":1},"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>g","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }?>
...
if ($vName==$session->userinfo['username']."'s village"){
	  /*
		0 => 'Task 3: Your Village\'s Name',
		1 => 'Creative as you are you can grant your village the ultimate name.\r\n<br \/><br \/>\r\nClick on \'profile\' in the left hand menu and then select \'change profile\'...',
		2 => 'Order:<\/p>Change your village\'s name to something nice.',
		3 => 'Wow, a great name for their village. It could have been the name of my village!'
	  */
?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][3][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][3][1];?>&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><?php echo $lang['quest'][3][2];?><\/div><br \/><span id=\"qst_accpt\"><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"village_name\"><\/div>\n\t\t","number":"-3","reward":false,"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }else{ ?>
{"markup":"\n\t\t<div id=\"qstd\"><h1> <img class=\"point\" src=\"img\/x.gif\" alt=\"\" title=\"\"\/><?php echo $lang['quest'][3][0];?><\/h1><br \/><i>&bdquo;<?php echo $lang['quest'][3][3];?>&rdquo;<\/i><br \/><br \/><div class=\"rew\"><p class=\"ta_aw\"><input type=\"hidden\" id=\"qst_val\" value=\"2\" \/><?php echo $lang['quest'][0][6]."<\/p>".resReward(30,60,30,20);?><\/div><br \/><span id=\"qst_accpt\"><a href=\"javascript: qst_next('','4');\"><?php echo $lang['quest'][0][5];?><\/a><\/span><\/div>\n\t\t<div id=\"qstbg\" class=\"village_name\"><\/div>\n\t\t","number":3,"reward":{"wood":30,"clay":60,"iron":30,"crop":20},"qgsrc":"q_l<?php echo $session->userinfo['tribe'];?>g","msrc":"<?php echo $messagelol; ?>","altstep":0}
<?php }?>
...
<?php } else { ?>
>>>>>>> .theirs
<<<<<<< .mine		header("Location: banned.php");
		} 
?>
=======<?php }}else{
